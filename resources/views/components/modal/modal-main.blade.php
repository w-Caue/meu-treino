<div class="flex justify-center">
    <div x-data="{ main: false, name: '{{ $name }}' }" x-show="main" x-cloak x-on:open-modal-main.window="main = ($event.detail.name === name)"
        ...
        <div
            class="w-full px-4 py-3 overflow-hidden bg-white rounded-t-2xl border border-gray-300 sm:rounded-2xl sm:m-4 sm:max-w-xl dark:bg-gray-900 dark:border-gray-700">
